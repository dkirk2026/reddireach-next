...
const faqs = [
  ...
  { q: 'Is marketing on Reddit worth it?', a: 'Yes, when it is done authentically. Reddit drives both direct discovery and AI recommendations, and AI referral traffic tends to convert at a higher rate than traditional search. We never use bots or spam; we build genuine community presence that compounds over time.' },
