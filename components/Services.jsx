    ...
    <section className="sect" id="services">
      <div className="pad" style={{ paddingBottom: '0' }}>
        <div className="sect-head">
          ...
          <p className="lead">Reddit marketing, subreddit community growth, link building, SEO and content marketing, delivered as one connected service. We do not just chase rankings, we build the credible, AI-cited presence that gets your brand recommended, and that single focus is what makes us different.</p>
        </div>
      </div>
      <div className="grid-2" style={{ marginTop: '48px' }}>
        <a className="cell" href="/services/reddit">
        ...
        <a className="cell" href="/services/link-building">
          <div className="ico">
        ...
        <a className="cell" href="/services/geo">
          <div className="ico">
